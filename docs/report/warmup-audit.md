...
## Note on `docs/architecture-decisions.md`
- The file exists and is focused on inbox draft-safety semantics rather than Route 2 warm-up behavior.
- It did not materially change the warm-up findings above.
